...
export default class SwipeCards extends Component {
  ...
  renderPlaceOrder() {
    ...
    if (this.props.renderPlaceOrder) {
      return this.props.renderPlaceOrder();
    }

    return <Defaults.renderPlaceOrder />;
  }
  ...
  renderMatched(){
      alert("calling matched");
      this.renderPlaceOrder();
     if(this.state.isMatched){
        return (
          <View style={{flex: 1}}>
            <Text style={styles.cardMatched}>Ehrfürchtig ... Sandwich auf dem Weg</Text>
          </View>
        )
     }
