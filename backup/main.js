    ...
    */
    ...
    var requests = [
      ...
      },
      {
        ...
        "body": {"FriendlyName":"","Company":"Amazon","GateCode":"","DeliveryInstructions":"","SaveInstructions":false,"CacheAddress":false,"Index":null,"AddressLine1":user_info.address.line1,"AddressLine2":user_info.address.line2,"City":user_info.address.city,"State":user_info.address.state,"Zipcode":user_info.address.zipcode,"Country":null,"DisplayText":null,"Longitude":user_info.address.longitude,"Latitude":user_info.address.latitude},
        "headers": {
          'Content-Type':'application/json;charset=UTF-8',
          'api-key':'A6750DD1-2F04-463E-8D64-6828AFB6143D'
        }
      ...
      },
      {
        ...
        "body":{"PaymentCode":"mycc_1","Amount":8.15,"CardHolderName":"","CardType":"","CreditCardNumber":"","ExpirationMonth":user_info.payment_info.exp_month,"ExpirationYear":user_info.payment_info.exp_year,"CvvNumber":user_info.payment_info.cvv,"BillingAddress1":user_info.address.line1,"BillingAddress2":user_info.address.line2,"BillingCity":user_info.address.city,"BillingState":user_info.address.state,"BillingCountry":"USA","BillingZipcode":user_info.address.zipcode,"SaveCreditCardInformation":false,"GiftCardNumber":"","GiftCardPinNumber":"","SaveGiftCardInformation":false},
        "headers": {
          'Content-Type':'application/json;charset=UTF-8',
          'api-key':'A6750DD1-2F04-463E-8D64-6828AFB6143D'
        }
      ...
      },
      {
        ...
        "body":{"CvvNumber":"","SaveAsInstantOrder":false},
        "headers": {
          'Content-Type':'application/json;charset=UTF-8',
          'api-key':'A6750DD1-2F04-463E-8D64-6828AFB6143D'
        }
